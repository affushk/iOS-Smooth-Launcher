...
public class MainActivity extends Activity {
    ...
    private void showEditor(String title){
      ...
      body=root;
      TextView save=t("✓  Save Theme",17,true);save.setGravity(Gravity.CENTER);save.setBackground(bg(accent,18));LinearLayout.LayoutParams sp=new LinearLayout.LayoutParams(-1,dp(58));sp.setMargins(0,dp(8),0,0);root.addView(save,sp);

...
public final class ThemeEngine {
 private ThemeEngine(){}
 public static final String ALTAF="Altaf AMOLED", GALAXY="One UI", STOCK="Stock Android", IOS="iOS Glass";
 ...
 public static int background(Context c){switch(name(c)){case GALAXY:return Color.rgb(18,18,20);case STOCK:return Color.rgb(15,18,24);case IOS:return Color.rgb(9,12,18);default:return Color.BLACK;}}
 public static int surface(Context c){switch(name(c)){case GALAXY:return Color.rgb(36,36,40);case STOCK:return Color.rgb(31,35,44);case IOS:return Color.rgb(30,34,43);default:return Color.rgb(12,12,13);}}
 public static int surfaceAlt(Context c){switch(name(c)){case GALAXY:return Color.rgb(48,48,54);case STOCK:return Color.rgb(43,49,62);case IOS:return Color.rgb(45,50,62);default:return Color.rgb(24,22,20);}}
 public static int accent(Context c){switch(name(c)){case GALAXY:return Color.rgb(92,145,255);case STOCK:return Color.rgb(180,204,255);case IOS:return Color.rgb(82,168,255);default:return Color.rgb(214,169,102);}}
 ...
 public static int dockRadius(Context c){switch(name(c)){case GALAXY:return 32;case STOCK:return 24;case IOS:return 40;default:return 16;}}
 ...
 public static int glassAlpha(Context c){switch(name(c)){case GALAXY:return 238;case STOCK:return 245;case IOS:return 150;default:return 248;}}
 public static int panelAlpha(Context c){switch(name(c)){case IOS:return 185;case GALAXY:return 248;case STOCK:return 252;default:return 252;}}
 ...
 public static String searchHint(Context c){switch(name(c)){case GALAXY:return "Finder search";case STOCK:return "Search your phone";case IOS:return "Search";default:return "Find";}}
